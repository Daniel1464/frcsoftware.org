...
```java stage1/Triggers.java#motorTooFastTrigger
...
```java stage1/Triggers.java#teleopEnabledRobot
...
<Aside type="note">
    ...
    ```java stage1/Triggers.java#multiBindingsVerbose

    ```
    
    You can also stack `whileTrue()` and `onTrue()` calls:
    ```java stage1/Triggers.java#multiBindings
...
```java stage1/Triggers.java#xboxGetAButton
...
```java stage1/Triggers.java#triggerAButton
...
```java stage1/Triggers.java#commandXboxController
...
```java stage1/Triggers.java#scheduleAndPrint
...
```java stage1/Triggers.java#timedRobotExample

```

Example `OpMode` usage:

```java stage1/Triggers.java#opModeExample
