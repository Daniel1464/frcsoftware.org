...
```java stage1/snippets/src/main/java/Triggers.java#motorTooFastTrigger
...
```java stage1/snippets/src/main/java/Triggers.java#teleopEnabledRobot
...
<Aside type="note">
    ...
    ```java stage1/snippets/src/main/java/Triggers.java#multiBindingsVerbose

    ```

    You can also stack `whileTrue()` and `onTrue()` calls:
    ```java stage1/snippets/src/main/java/Triggers.java#multiBindings
...
```java stage1/snippets/src/main/java/Triggers.java#xboxGetAButton
...
```java stage1/snippets/src/main/java/Triggers.java#triggerAButton
...
```java stage1/snippets/src/main/java/Triggers.java#commandXboxController
...
```java stage1/snippets/src/main/java/Triggers.java#scheduleAndPrint
...
```java stage1/snippets/src/main/java/Triggers.java#timedRobotExample

```

Example `OpMode` usage:

```java stage1/snippets/src/main/java/Triggers.java#opModeExample
