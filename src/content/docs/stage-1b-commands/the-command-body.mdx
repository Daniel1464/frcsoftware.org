...
```java stage1/snippets/src/main/java/CommandBody.java#triangleLoop
...
```java stage1/snippets/src/main/java/CommandBody.java#fullThrottleCmdBody

```

And this command body would rotate your robot by roughly 90 degrees, then stop:

```java stage1/snippets/src/main/java/CommandBody.java#rotate90CommandBody
