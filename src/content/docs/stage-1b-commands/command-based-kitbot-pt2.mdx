...
<details class="accordion">
    ...
    ```java stage1/snippets/src/main/java/CommandBasedKitbotPt2.java#arcadeDriveBody
...
<details class="accordion">
    ...
    ```java stage1/snippets/src/main/java/CommandBasedKitbotPt2.java#driveCommand
...
<details class="accordion">
    ...
    ```java stage1/snippets/src/main/java/CommandBasedKitbotPt2.java#startMethod
...
<details class="accordion">
    ...
    ```java stage1/snippets/src/main/java/CommandBasedKitbotPt2.java#4SecDriveCommand
...
<details class="accordion">
    <summary>Hint</summary>
    ```java stage1/snippets/src/main/java/CommandBasedKitbotPt2.java#rotateInPlaceBody
