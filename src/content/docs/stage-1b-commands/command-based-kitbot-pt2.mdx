...
<details class="accordion">
    ...
    following inside of your command's body: ```java
    stage1/CommandBasedKitbotPt2.java#arcadeDriveBody ```
</details>
...
<details class="accordion">
    ...
    ```java stage1/CommandBasedKitbotPt2.java#driveCommand
...
<details class="accordion">
    ...
    ```java stage1/CommandBasedKitbotPt2.java#startMethod
...
<details class="accordion">
    ...
    ```java stage1/CommandBasedKitbotPt2.java#4SecDriveCommand
...
<details class="accordion">
    <summary>Hint</summary>
    ```java stage1/CommandBasedKitbotPt2.java#rotateInPlaceBody
