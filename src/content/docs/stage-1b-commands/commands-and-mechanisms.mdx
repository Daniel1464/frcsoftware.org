...
```java stage1/CommandsAndMechsPt1.java#mechanismDef
...
```java stage1/CommandsAndMechsPt1.java#mechanismInRobotDef
...
```java stage1/CommandsAndMechsPt1.java#commandDef
...
```java stage1/CommandsAndMechsPt1.java#commandWithPriorityDef
