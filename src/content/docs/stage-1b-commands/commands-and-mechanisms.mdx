...
```java stage1/snippets/src/main/java/CommandsAndMechsPt1.java#mechanismDef
...
```java stage1/snippets/src/main/java/CommandsAndMechsPt1.java#mechanismInRobotDef
...
```java stage1/snippets/src/main/java/CommandsAndMechsPt1.java#commandDef
...
```java stage1/snippets/src/main/java/CommandsAndMechsPt1.java#commandWithPriorityDef
