...
```java stage1/SuppliersInCommandBased.java#runAtThrottleDouble

```

And the following code in Robot.java:

```java stage1/SuppliersInCommandBased.java#incorrectCommand
...
```java stage1/SuppliersInCommandBased.java#runAtThrottleSupplier
...
```java stage1/SuppliersInCommandBased.java#doubleSupplierExample
...
```java stage1/SuppliersInCommandBased.java#correctCommand
...
```java stage1/SuppliersInCommandBased.java#triggerBooleanSupplier
...
```java stage1/SuppliersInCommandBased.java#untilModifier
