...
```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#runAtThrottleDouble

```

And the following code in Robot.java:

```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#incorrectCommand
...
```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#runAtThrottleSupplier
...
```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#doubleSupplierExample
...
```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#correctCommand
...
```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#triggerBooleanSupplier
...
```java stage1/snippets/src/main/java/SuppliersInCommandBased.java#untilModifier
