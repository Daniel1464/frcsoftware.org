...
<Aside type="note">
Notice that we said command body, not command! The command body defines the actions it
executes after it is run. However, a command must also define requirements, priority,
and more.
</Aside>
...
inside of commands. Some of these will be mentioned in the following sections.
