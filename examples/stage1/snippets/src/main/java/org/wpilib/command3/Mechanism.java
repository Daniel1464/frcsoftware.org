...
/**
 * A "shim" for the `Mechanism` interface. In WPILib 2027 alpha 6,
 * Mechanisms were still classes; however, alpha 7 changes them to interfaces.
 * In an effort to not rewrite any docs, this shim will exist for now until alpha 7
 * releases.
 */
